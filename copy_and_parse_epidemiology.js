...
const targetFileName = '2.2 Epidemiology.pptx';
const searchRoots = [
...
const tempZip = path.join(scratchDir, 'temp_epidemiology.zip');
const tempDir = path.join(scratchDir, 'temp_epidemiology');
...
let mdContent = `# 2.2 Epidemiology Lecture Slides Reference\n\n`;
...
const outputPath = path.join(scratchDir, 'epidemiology_slides_text.md');
