...
const targetFileName = '3.1 Method of Plant Disease Control.pptx';
const searchRoots = [
...
const tempZip = path.join(scratchDir, 'temp_control.zip');
const tempDir = path.join(scratchDir, 'temp_control');
...
let mdContent = `# 3.1 Method of Plant Disease Control Lecture Slides Reference\n\n`;
...
const outputPath = path.join(scratchDir, 'control_slides_text.md');
