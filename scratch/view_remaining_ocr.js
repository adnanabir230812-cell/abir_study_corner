...
if (fs.existsSync(filePath)) {
  ...
  lines.forEach((line, idx) => {
    ...
    if (l.startsWith('=== PAGE')) {
      const pageNum = parseInt(l.match(/PAGE (\d+)/)[1]);
      if (pageNum >= 4) {
        printing = false; // reset
        console.log(`\n\n============================================================`);
        console.log(`${l}`);
        console.log(`============================================================`);
      }
    }
    if (l.includes('Examination 20') || l.includes('Session 20') || l.includes('Term-I1 Examination') || l.includes('Term II Examination')) {
      currentHeader = l;
    }
