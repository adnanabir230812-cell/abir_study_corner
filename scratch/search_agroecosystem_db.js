    ...
    secB.Topics.forEach(t => {
      if (t.Questions) {
        t.Questions.forEach(q => {
          ...
          if (lower.includes('agroecosystem') || lower.includes('agro-ecosystem') || lower.includes('natural ecosystem') || lower.includes('sustainability') || lower.includes('equitability')) {
