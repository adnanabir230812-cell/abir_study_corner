# Solved Past Exam & Class Test Questions
**Course: AT-3203 Crop Ecology (Section B — Sarwar Sir)**
**Agrotechnology Discipline, Khulna University**
*Solved strictly based on Sarwar Sir's slides (2016–2025)*

---

## Topic 1: Ecosystem: Definition & Classification

### Q1. Write the definition and classification of ecosystem with example.  [3]  (2019-20)

An ecosystem is the self-sustaining structural and functional interaction between living (biotic) and non-living (abiotic) components of the environment in a geographic location.
...
### Q2. Classify ecosystem with examples.  [3]  (2019)
...
### Q3. Enlist the major ecosystems of the world.  [2]  (2016-17)
...
### Q1. 'Ecosystem is the basic structural and functional unit of ecology' — comprehend.  [4]  (2023)

An ecosystem is considered the basic structural and functional unit of ecology because it encompasses all the living components and physical factors, along with their dynamic interactions, required to sustain life.
...
### Q2. 'Ecosystem is the basic structural and functional unit of ecology' — explain.  [4]  (2019, 2021 (same Q))
...
### Q1. Give an outline of the components of ecosystem in maize field.  [3]  (2025)

A maize field ecosystem consists of biotic and abiotic components structured specifically for agricultural production:
...
### Q2. Write down the components of ecosystem in rice field.  [5]  (2024)

A rice field ecosystem consists of biotic and abiotic components structured specifically for agricultural production:
...
### Q3. Briefly describe different components of a crop ecosystem.  [4]  (2019-20)

A crop field ecosystem consists of biotic and abiotic components structured specifically for agricultural production:
...
### Q4. Briefly describe the structure of a crop field ecosystem.  [3]  (2017-18)
...
### Q1. Assess the attributes of an agroecosystem.  [4]  (2025)

An agroecosystem is an ecological system modified by humans to produce agricultural products. It has four main properties/attributes:
...
### Q2. Draw and explain the pathway of flow of energy in an agroecosystem.  [4]  (2019)

Energy flow in an agroecosystem is an open, managed pathway driven by solar energy and human inputs:
...
### Q3. Describe the attached sketch in terms of efficient agricultural crop production (Attachment 01).  [4]  (2019-20)

An agroecosystem represents an open, managed pathway where inputs and outputs are highly manipulated:
...
### Q1. 'Energy flow in an ecosystem follows the laws of thermodynamics' — argue / explain.  [3–4]  (2023, 2020-21, 2017-18)

The flow of energy through an ecosystem strictly follows the first and second laws of thermodynamics:
...
### Q1. Distinguish between food chain and food web.  [3]  (2025, 2016-17)

A food chain is a single, linear pathway showing the flow of energy from one organism to another. A food web is a complex network of interconnected food chains showing all feeding relationships in an ecosystem.
...
### Q2. Differentiate food chain from food web with diagram.  [3–4]  (2020-21, 2017-18)
...
### Q3. Sketch a 'food-chain' and a 'food-web'.  [2]  (2019-20)
...
### Q4. State the importance of food chain.  [2]  (2024)

The importance of food chains in an ecosystem include:
...
### Q5. Enumerate the significance of food chain.  [2]  (2016-17)

The significance and importance of food chains in an ecosystem include:
* Energy Flow: They serve as the primary pathways for transferring energy from the sun (via producers) to consumers.
* Nutrient Cycling: They facilitate the movement of essential nutrients through the biotic components of the ecosystem and back to the soil via decomposers.
* Population Regulation: They help maintain ecological balance by regulating the populations of prey and predators.
* Ecosystem Stability: They aid in assessing the overall health and stability of the environment. If any link is broken, it can disrupt the entire ecosystem.
...
### Q1. Compare and contrast between pyramid of number and pyramid of biomass with diagram.  [4]  (2025)
...
### Q2. Briefly describe different types of ecological pyramids.  [3]  (2024)

An ecological pyramid is a graphical representation of the relationship between organisms at different trophic levels. The three types of Eltonian pyramids are:
...
### Q3. Schematically show different types of Eltonian pyramids.  [3]  (2023)

The three types of Eltonian pyramids can be schematically represented as follows:
...
### Q4. Draw and label different types of ecological pyramids.  [3]  (2019-20, 2016-17)

The three types of Eltonian pyramids can be drawn and labeled as follows:
...
### Q1. What is trophic level? Differentiate net primary productivity from gross primary productivity.  [3]  (2020-21)

* Trophic Level: It refers to each feeding level in a food chain or ecosystem (e.g., Producers, Herbivores, Carnivores).
* Differences:
...
### Q2. 'Productivity of an ecosystem is greatly influenced by environment' — justify.  [3]  (2019)

Primary productivity in ecosystems is limited and controlled by several key environmental factors:
...
### Q3. How does environment play a role in the productivity of an ecosystem?  [3]  (2016-17)
...
### Q1. Mention the methods of measuring productivity of an ecosystem. Describe any of them.  [3]  (2023, 2020-21, 2017-18)

Methods for measuring primary productivity in ecosystems include:
...
### Q1. Explain crop association.  [2]  (2024)
...
### Q2. What is crop association? Illustrate different forms of crop association.  [4]  (2023)

Crop association is the simultaneous production of a number of crops at the same time in the same farming area to maximize the synergies and biological interactions among them.
...
### Q3. What is crop association? Write down the principles of mixed cropping.  [3]  (2016-17)
...
### Q4. Enumerate the basic principles of crop association.  [3]  (2019)

The basic principles of crop association are:
...
### Q5. Enumerate the limitations of crop association.  [2]  (2024)

The limitations of crop association include:
...
### Q1. What is crop association? Illustrate different forms of intercropping with examples.  [4]  (2020-21, 2019-20, 2017-18)

Intercropping is the practice of growing two or more crops in proximity to utilize resources that would otherwise not be utilized in monoculture.
...
### Q2. Compare and contrast between mixed intercropping and row intercropping.  [3]  (2024, 2023)

| Features | Mixed Intercropping | Row Intercropping |
| :--- | :--- | :--- |
...
### Q3. Briefly describe different forms of row intercropping.  [3]  (2016-17)

Row intercropping involves growing two or more crops simultaneously in specific row arrangements:
...
### Q1. Distinguish between relay cropping and ratoon cropping.  [3]  (2023)

* Relay Cropping: Involves growing two or more crops simultaneously during part of their life cycles, where the second crop is sown into the standing first crop when the first reaches its reproductive stage (e.g., mustard sown in Aman rice before harvest).
...
### Q1. Discuss the differences between mixed cropping and intercropping.  [3]  (2025)

| Features | Intercropping | Mixed Cropping |
| :--- | :--- | :--- |
...
### Q2. Compare and contrast between intercropping and mixed cropping.  [3]  (2017-18)
...
### Q3. Which one should you follow between intercropping and mixed cropping for better yield? Justify your answer.  [3]  (2020-21)

For better yields and resource use efficiency, **intercropping** is preferred over mixed cropping:
...
### Q1. Assess the principles of selecting crops for intercropping.  [3]  (2025)

The principles of crop selection for intercropping include:
...
### Q2. Which management practices should be followed during intercropping?  [3]  (2019)

Key management practices in intercropping are:
...
### Q1. 'Multiple cropping is the sole option to increase cropping intensity in Bangladesh' — give your argument.  [4]  (2019-20)

Multiple cropping is the most viable option to increase cropping intensity in Bangladesh:
...
### Q1. Suppose land equivalent ratio (LER) of the intercropping between mungbean and potato is 1.76. Interpret the statement.  [3]  (2024)

An LER of 1.76 means there is a significant land-use advantage in intercropping mungbean and potato over growing them as monocultures:
...
### Q2. Land equivalent ratio (LER) of intercropping between sugarcane and potato is 1.45. How can you interpret it?  [2]  (2023)

An LER of 1.45 indicates a land-use advantage:
...
### Q3. Relative yield total (RYT) of intercropping between maize and mungbean is 1.45. How will you explain it?  [2]  (2019-20)

Relative Yield Total (RYT) is conceptually equivalent to LER. An RYT of 1.45 means that growing maize and mungbean together in an intercrop mixture requires 45% less land area than growing them separately as sole crops to produce the same quantity of yield. It indicates a significant resource-use and land efficiency advantage.

* * *

### Q4. Relative yield total (RYT) of intercropping between maize and blackgram is 1.48. How can you explain it?  [2]  (2016-17)

Relative Yield Total (RYT) of 1.48 indicates a land-use advantage. It means that growing maize and blackgram together in an intercrop mixture requires 48% less land area than growing them separately as sole crops to achieve the same yield. This represents a 48% increase in land productivity.

* * *

## Topic 18: Food Chain & Food Web [Cross-listed]

### Q1. Distinguish between food chain and food web.  [2]  (2016-17)
...
### Q1. What are meant by pollution and pollutants? Propose some measures to reduce environmental pollution in Bangladesh.  [4]  (2017-18)
...
### Q1. Describe the impact of air pollution on human health.  [3]  (2025)

Air pollutants have severe impacts on human health:
...
### Q2. Propose some measures to reduce air pollution in Khulna city.  [3]  (2024)

Measures to check air pollution in Khulna city include:
...
### Q3. Describe the sources and causes of air pollution.  [3]  (2017-18)

Air is polluted by natural and anthropogenic sources:
...
### Q4. How is air polluted?  [4]  (2020-21)
...
### Q5. Enlist the sources of air pollution. How can you mitigate the adverse effect of environmental pollution?  [10]  (Class Test)
...
### Q1. Analyze how unnecessary use of agrochemicals leads to water pollution.  [3.5]  (2025)

Unnecessary use of agrochemicals (pesticides, herbicides, fertilizers) contaminates water bodies through two main pathways:
...
### Q2. 'Continuous water pollution is a leading cause of global fresh water scarcity over the period of time.' Do you agree? Justify.  [2]  (2023)

Yes, water pollution is a major cause of freshwater scarcity:
...
### Q3. What is eutrophication? Describe the effects of water pollution on aquatic animals and man.  [4]  (2023, 2019)

* Eutrophication: The nutrient enrichment of water bodies (via nitrogen and phosphorus runoff from agricultural fertilizers and municipal sewage) that stimulates excessive growth of algae (algal blooms).
...
### Q4. Explain the causes and impact of water pollution for agroecosystem.  [4]  (2020-21)

The causes and impacts of water pollution on agroecosystems are:
* Causes:
...
### Q5. Enumerate the sources and causes of water pollution in Khulna region.  [3]  (2019-20)

Sources and causes of water pollution in Khulna region:
* Point Sources:
...
### Q6. Clarify eutrophication.  [2]  (2024)

Eutrophication is the nutrient enrichment of water bodies (principally nitrogen and phosphorus), often from sewage discharge or agricultural fertilizer runoff. This excess of nutrients leads to rapid growth of algae (algal blooms). When the algae die, decomposers (bacteria) multiply and consume large amounts of dissolved oxygen (D.O.) to break down the organic matter, suffocating fish and creating dead zones.

* * *

## Topic 22: Key Terms: Bioaccumulation, Biomagnification, BOD, DO

### Q1. What are bioaccumulation and biomagnification?  [2]  (2024)

* Bioaccumulation: The accumulation of a toxic chemical (such as DDT or methylmercury) in the tissues of a single organism over its lifetime because it is lipid-soluble and cannot be easily excreted.
...
### Q2. What is Minamata disease?  [2]  (2024)
...
### Q3. Explain Itai-Itai disease.  [1.5]  (2025)

Itai-Itai disease is a painful bone-softening disease caused by chronic cadmium poisoning:
...
### Q1. Suggest some measures to reduce soil pollution in our country.  [3]  (2023)

Measures to reduce soil pollution in our country include:
...
### Q1. Develop strategies to reduce environmental pollution caused by agrochemicals.  [3.5]  (2025)

Strategies to reduce environmental pollution caused by agrochemicals:
...
### Q2. 'Improper use of agrochemicals is a great threat to human health.' — Evaluate.  [3]  (2024)

Improper use of agrochemicals (fertilizers and pesticides) poses severe threats to human health:
...
### Q3. 'Improper use of agrochemicals is a potential threat to human health in Bangladesh' — analyze.  [3]  (2019-20)

Improper use of agrochemicals (fertilizers and pesticides) poses severe threats to human health in Bangladesh:
* Direct Exposure: Farmers spraying chemicals without protective gear inhale toxins, leading to acute poisoning, skin diseases, and respiratory disorders.
* Food Contamination: Pesticide residues remain on harvested crops. When consumed, they can act as carcinogens and cause endocrine disruptions.
* Water Contamination: Soluble nitrates leach into drinking water wells, causing Blue Baby Syndrome (methemoglobinemia) in infants, and forming cancer-causing compounds in the stomach.
* Biomagnification: Non-biodegradable chemicals like DDT build up in lipid tissues and bioaccumulate, causing long-term damage to the liver, kidneys, and nervous system.
...
### Q4. 'Improper use of insecticides is a great threat to human health'. Evaluate the statement.  [3]  (2017-18)

Improper use of insecticides is a great threat to human health:
* Direct Exposure: Farmers spraying chemicals without protective gear inhale toxins, leading to acute poisoning, skin diseases, and respiratory disorders.
* Food Contamination: Pesticide residues remain on harvested crops. When consumed, they can act as carcinogens and cause endocrine disruptions.
* Water Contamination: Soluble nitrates leach into drinking water wells, causing Blue Baby Syndrome (methemoglobinemia) in infants, and forming cancer-causing compounds in the stomach.
* Biomagnification: Non-biodegradable chemicals like DDT build up in lipid tissues and bioaccumulate, causing long-term damage to the liver, kidneys, and nervous system.
...
### Q5. 'Agrochemicals are potential threats for maintaining soil fertility and productivity'. Explain.  [4]  (2020-21)

Agrochemicals can severely degrade soil quality and long-term productivity:
...
### Q6. What might be the remedial measures to reduce the detrimental effects of agrochemicals on environment?  [3]  (2019)

Remedial measures to reduce the detrimental effects of agrochemicals on environment:
* Judicious Application: Train farmers to apply the right quantity of fertilizers and pesticides based on soil tests.
* Buffer Strips: Plant grasses, shrubs, or trees along field borders and near water bodies to filter out chemicals from surface runoff.
* Integrated Pest Management (IPM): Combine biological controls, mechanical traps, and crop rotation to reduce chemical pesticide use.
* Cover Crops: Plant cover crops (e.g., oats, vetch, cowpeas) during fallow periods to stabilize soil and prevent nutrient leaching.
...
### Q7. Propose some options to reduce environmental pollution in our country.  [4]  (2019-20)

Key options to reduce environmental pollution in Bangladesh:
...
### Q8. Briefly describe the effects of agrochemicals on ecosystem.  [10]  (Class Test)

Once applied, pesticides as well as fertilizers do not disappear completely: some are absorbed by the plants, while the rest must be processed by the environment. This leads to several detrimental effects on the ecosystem:
...
### Q1. Review the role of bioremediation in controlling environmental pollution.  [3]  (2025)

Bioremediation is the use of living organisms (such as bacteria, fungi, or plants) to break down, remove, or neutralize hazardous environmental pollutants:
...
### Q1. 'Plant acts as ameliorator of environment quality' — judge / explain.  [2–4]  (2020-21, 2019)

Plants act as natural cleaners and ameliorators of environmental quality in several ways:
...
### Q1. How do halophytes cope with salinity?  [3]  (2023)

Halophytes are specialized plants adapted to survive in highly saline environments through several mechanisms:
...
### Q1. 'The geographical location of Bangladesh is mostly responsible for ecological hazard' — explain.  [3]  (2016-17)

The geographical location of Bangladesh makes it highly vulnerable to ecological hazards:
...
### Q2. Illustrate disaster management cycle.  [3]  (2016-17)

The disaster management cycle consists of key continuous phases:
* Pre-Disaster Phase:
...
### Q3. Differentiate between: (i) hazard and disaster; (ii) cyclone and tropical storm.  [4]  (2016-17)

* (i) Hazard vs. Disaster:
...
### Q1. Which environmental conditions are essential for the development of mangrove vegetation?  [2]  (2019)

The environmental and ecological conditions essential for mangrove development are:
...
### Q2. State the ecological conditions necessary for mangrove vegetation.  [2]  (2016-17)
...
### Q1. Briefly describe the modification of roots in halophyte.  [3]  (2020-21, 2019)

Halophytes (mangroves) develop specialized root modifications to survive in unstable, low-oxygen, and waterlogged coastal soils:
...
### Q2. Which modifications in root occur in halophyte?  [2]  (2016-17)
...
### Q1. How does vivipary help halophytes to survive in saline/coastal environment?  [2]  (2024, 2019-20, 2016-17)

* Vivipary is the phenomenon where seeds germinate and develop into seedlings (propagules) while still attached to the parent plant.
...
### Q1. How does halophyte cope with saline soil?  [3]  (2017-18)

Halophytes survive in saline soils through key physiological adaptations:
...
### Q2. How do halophytes cope with salinity?  [3]  (2023)
...
### Q1. 'Mangrove vegetation has great significance on ecological aspects and livelihood development in coastal areas of Bangladesh' — explain.  [3]  (2023)

Mangrove forests in Bangladesh (such as the Sundarbans) play a vital dual role in ecological protection and livelihood support:
...
### Q2. State the ecological significance of mangrove vegetation in Bangladesh.  [4]  (2020-21)
...
### Q3. 'Mangrove forest is a livelihood option for coastal community' — explain.  [4]  (2016-17)
...
### Q1. Assess the ecological significance of the Sundarbans for Bangladesh's environment.  [3.5]  (2025)

The Sundarbans (571,508 ha) is of immense ecological significance to Bangladesh's environment:
...
### Q2. 'The Sundarbans is an alternative livelihood option for people of Khulna and Satkhira.' — Assess.  [3.5]  (2024)

The Sundarbans is a vital alternative livelihood option for the coastal communities of Khulna, Bagerhat, and Satkhira:
...
### Q3. 'The Sunderbans is an alternative livelihood option for coastal people of Bangladesh' — assess.  [4]  (2019-20)
...
### Q4. 'The Sundarbans is an alternative livelihood option for coastal people of Bangladesh'. Justify.  [5]  (2017-18)
...
### Q5. Illustrate the significance of the Sundarbans in coastal community. How can the biodiversity of this forest be conserved?  [5]  (2019)

The Sundarbans represents a crucial livelihood and ecological protection shield for the coastal community.
...
### Q1. How does the succession of mangrove formation in coastal region greatly affect by the gradual elevation of the sea coast?  [3]  (2020-21)

Mangrove succession in coastal regions is significantly affected by the gradual elevation of the sea coast due to silt deposition:
...
### Q2. Write a note on succession of mangrove vegetation in sea coast.  [2]  (2017-18)

Mangrove succession is the progressive transition of plant species as sea coasts gradually elevate due to silt deposition:
...
### Q1. Describe the distribution of coastal vegetation along Bangladesh's shoreline.  [2]  (2025)

The distribution of coastal vegetation along Bangladesh's shoreline is structured as follows:
...
### Q2. Write a note on coastal vegetation in Bangladesh.  [2.5]  (2024)

The coastal vegetation of Bangladesh consists of man-made and natural species:
...
### Q3. Write an essay on coastal vegetation of Bangladesh.  [4]  (2019-20)
