...
const targetFileName = '3.3 Chemical Control.pptx';
const searchRoots = [
...
const tempZip = path.join(scratchDir, 'temp_chemcontrol.zip');
const tempDir = path.join(scratchDir, 'temp_chemcontrol');
...
let mdContent = `# 3.3 Chemical Control Lecture Slides Reference\n\n`;
...
const outputPath = path.join(scratchDir, 'chemcontrol_slides_text.md');
